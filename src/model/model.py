...
def initialize_model(model,
    ...
    model.ActivePowerGenerated = Var(model.Phases, model.DERs, model.TimePeriods, within = Reals, bounds = activepower_bounds_rule)
    ...
    model.CapacitorSwitchingState = Var(model.Phases, model.Capacitors, model.TimePeriods, within = NonNegativeIntegers, bounds = max_switch_rule)
